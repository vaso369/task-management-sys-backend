...
class Tasks
{
    ...
    public function addTask($idBoss, $idEmployee, $taskName, $description, $uniqueId, $date, $priority)
    {
        return $this->db->executeOneRow("INSERT INTO tasks VALUES (NULL,?,?,?,?,?,?,?,0)", [$idBoss, $idEmployee, $uniqueId, $taskName, $description, $date, $priority]);
    }
}
